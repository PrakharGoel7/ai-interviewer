...
export default function ReportPage() {
    ...
    const formatEvidence = (items, isImprovement) => {
        if (!isIBMode || !isImprovement)
            return items;
    ...
    return (_jsxs("div", { className: "report-shell premium", children: [_jsxs("section", { className: "hero-card card", children: [_jsxs("div", { className: "hero-left", children: [_jsx("p", { className: "kicker", children: isIBMode ? 'IB Interview Performance Report' : 'Case Performance Report' }), _jsx("h1", { className: "hero-headline", children: report.case.title }), _jsxs("div", { className: "summary-tags", children: [_jsx("span", { className: "tag", children: report.case.type }), _jsx("span", { className: "tag", children: report.case.industry })] }), _jsxs("p", { className: "hero-meta", children: ["Completed ", report.case.completedAt, " \u00B7", ' ', Math.max(1, Math.round(report.case.durationSec / 60)), " min"] }), _jsx("p", { className: "hero-subhead", children: heroSummary }), saveMessage && _jsx("p", { className: "muted save-note", children: saveMessage })] }), _jsxs("div", { className: "hero-rating", "aria-label": ratingNumber != null
                        ...
                        }) }), selectedRubric && (_jsxs("div", { className: "scorecard-details", "aria-live": "polite", children: [_jsx("h3", { children: selectedRubric.title }), _jsxs("div", { className: "details-grid", children: [_jsx(EvidenceSection, { title: "Strengths", items: formatEvidence(selectedRubric.strengths, false) }), _jsx(EvidenceSection, { title: "Areas for improvement", items: formatEvidence(selectedRubric.improvements, true) })] })] }))] })] }));
}
