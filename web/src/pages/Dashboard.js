...
export default function Dashboard() {
    ...
    return (_jsxs("div", { className: "dashboard-shell", children: [_jsxs("div", { className: "view-toggle-row", children: [_jsxs("div", { className: "control-group mode-selector", children: [_jsx("p", { className: "control-label", children: "Mode" }), _jsxs("div", { className: "track-toggle", role: "tablist", "aria-label": "Interview mode", children: [_jsx("button", { type: "button", className: track === 'consulting' ? 'active' : '', onClick: () => handleTrackChange('consulting'), "aria-pressed": track === 'consulting', children: "Consulting" }), _jsx("button", { type: "button", className: track === 'ib' ? 'active' : '', onClick: () => handleTrackChange('ib'), "aria-pressed": track === 'ib', children: "Investment banking" })] })] }), _jsxs("div", { className: "control-group view-selector", children: [_jsx("p", { className: "control-label subtle", children: "View" }), _jsxs("div", { className: "dashboard-tabs compact view-tabs", role: "tablist", "aria-label": "Dashboard view", children: [_jsx("button", { type: "button", className: activeTab === 'progress' ? 'tab active' : 'tab', onClick: () => setActiveTab('progress'), "aria-pressed": activeTab === 'progress', children: "Progress" }), _jsx("button", { type: "button", className: activeTab === 'history' ? 'tab active' : 'tab', onClick: () => setActiveTab('history'), "aria-pressed": activeTab === 'history', children: "Case history" })] })] })] }), error && _jsx("div", { className: "banner error-banner", children: error }), loading && !cases.length ? (_jsx("div", { className: "card", children: _jsx("p", { children: "Loading your data\u2026" }) })) : track === 'consulting' ? (activeTab === 'progress' ? (_jsx(ProgressTab, { cases: consultingCases, onViewHistory: handleViewHistory })) : (_jsx(HistoryTab, { cases: consultingCases, filters: consultingFilters, onChangeFilters: setConsultingFilters, onLoadMore: loadMore, hasMore: hasMore, loading: loadingMore }))) : activeTab === 'progress' ? (_jsx(IBProgressTab, { cases: ibCases })) : (_jsx(HistoryTab, { cases: ibCases, filters: ibFilters, onChangeFilters: setIbFilters, onLoadMore: loadMore, hasMore: hasMore, loading: loadingMore }))] }));
}
